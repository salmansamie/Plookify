...
public class FXMLDocumentController implements Initializable
{
    ...
    private void myListsOnClick()
    {
        ...
        catch (FileNotFoundException ex)
        {
            ...
            new Alert(AlertType.ERROR, "Playlist could not be loaded. The list is corrutped.", ButtonType.OK).showAndWait();
    ...
    private void plusNowPlayingOnClick()
    {
        ...
        new Alert(AlertType.INFORMATION, plts.size() + " tracks added to Now Playing queue.", ButtonType.OK).showAndWait();
    ...
    private void plusNowPlayingFOnClick()
    {
        ...
        new Alert(AlertType.INFORMATION, fplts.size() + " tracks added to Now Playing queue.", ButtonType.OK).showAndWait();
    ...
    private void removeTrackOnClick()
    {
        ...
        if (i < 0 || j < 0)
        {
            new Alert(AlertType.ERROR, "Please select a track to remove.", ButtonType.OK).showAndWait();
        ...
        {
            Logger.getLogger(FXMLDocumentController.class.getName()).log(Level.SEVERE, null, ex);
            new Alert(AlertType.ERROR, "Playlist could not be updated. The list is corrutped.", ButtonType.OK).showAndWait();
        ...
        new Alert(AlertType.INFORMATION, "Track removed successfully from the playlist", ButtonType.OK).showAndWait();
    ...
    private void removePlaylistOnClick()
    {
        ...
        if (i < 0)
        {
            new Alert(AlertType.ERROR, "Please select a playlist to remove.", ButtonType.OK).showAndWait();
        ...
        new Alert(AlertType.INFORMATION, "Playlist removed successfully", ButtonType.OK).showAndWait();
    ...
    private void renamePlaylistOnClick()
    {
        ...
        {
            new Alert(AlertType.ERROR, "Playlist with this name already exists. Choose another.", ButtonType.OK).showAndWait();
        ...
        new Alert(AlertType.INFORMATION, "Playlist renamed successfully", ButtonType.OK).showAndWait();
    ...
    private void addSearchOnClick()
    {
        ...
        {
            new Alert(AlertType.ERROR, "Please select atleast one track.", ButtonType.OK).showAndWait();
        ...
        {
            new Alert(AlertType.ERROR, "Please select a playlist or provide a name for new playlist.", ButtonType.OK).showAndWait();
        ...
        if (index >= 0 && plname.equalsIgnoreCase(pls.get(index).getPlaylistPK().getName()))
            try
            {
                ...
                new Alert(AlertType.INFORMATION, "Playlist updated successfully", ButtonType.OK).showAndWait();
            ...
            try
            {
                ...
                new Alert(AlertType.INFORMATION, "Playlist created successfully", ButtonType.OK).showAndWait();
                //JOptionPane.showMessageDialog(null, "Playlist created successfully", "Playlist created", JOptionPane.INFORMATION_MESSAGE);
            }
            catch (FileNotFoundException ex)
            {
                Logger.getLogger(FXMLDocumentController.class.getName()).log(Level.SEVERE, null, ex);
                new Alert(AlertType.ERROR, "Playlist could not be created.", ButtonType.OK).showAndWait();
