...
public class Main extends Application {
  ...
  /*  // The Radio Realm InsideRadio.fxml
    public void showRadioScene() throws IOException{
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(Main.class.getResource("InsideRadio.fxml"));
        BorderPane radioScene = loader.load();
        mainLayout.setCenter(radioScene);
